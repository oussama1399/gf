...
if (isset($_POST['connection'])) {
    ...
    if (empty($identifiant) || empty($password)) {
        ...
        try {
            ...
            $stmt = $pdo->prepare("SELECT id, username, email, password_hash, role, fonction FROM users WHERE username = ? OR email = ? LIMIT 1");
            ...
            <div class="auth-card">
                <div class="card-body">
                    ...
                    <div class="auth-footer">
                        Pas encore de compte ? <a href="register.php" class="auth-link">S'inscrire</a>
                    </div>
                </div>
            </div>
        </div>
